...
HMMVVdfUsageContext::HMMVVdfUsageContext( QTabWidget * flexiTabWidget ) :
    flexiTabWidget(flexiTabWidget), 
    groupID(-1)
{
...
void HMMVVdfUsageContext::activateContext( QWidget * contextWidget )
{
    //nie wpsieramy kontekstu bez widgeta i nie ma sensu nic z kontekstem robic skoro jest już zaladowany
    if(contextWidget == nullptr || groupID != -1){
        return;
...
void HMMVVdfUsageContext::deactivateContext( QWidget * nextContextWidget, bool refresh )
{
    if(nextContextWidget == getCurrentContextWidget()){
        return;
    }
...
void HMMVVdfUsageContext::onRegisterContextWidget( QWidget * contextWidget )
{
...
void HMMVVdfUsageContext::onUnregisterContextWidget( QWidget * contextWidget )
{
