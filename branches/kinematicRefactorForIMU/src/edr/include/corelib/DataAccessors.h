...
namespace core {
    ...
    //!     zdefiniowanego w zasadach wskaźników dla wrappera.
    template <class SmartPtr>
    inline std::vector<SmartPtr> queryDataPtr(IDataManagerReaderOperations* manager, bool exact = false, SmartPtr* /*dummy*/ = nullptr)
    {
    ...
    private:
        IDataManagerReaderOperations* manager;
        bool exact;
        //! \param manager
        //! \param exact
    public:
        inline queryDataPtr_t(IDataManagerReaderOperations* manager, bool exact = false) :
    ...
    inline queryDataPtr_t queryDataPtr(IDataManagerReaderOperations* manager, bool exact = false)
    {
