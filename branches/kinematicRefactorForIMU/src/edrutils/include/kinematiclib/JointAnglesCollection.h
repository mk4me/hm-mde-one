...
namespace kinematic
{
	...
	typedef utils::shared_ptr<JointAngleChannel> JointAngleChannelPtr;
	typedef utils::shared_ptr<const JointAngleChannel> JointAngleChannelConstPtr;
...
//	void setSkeletal(kinematic::SkeletonConstPtr skeletalModel, const kinematic::SkeletonStates& skeletalData);// ,
	...
	const kinematic::SkeletonConstPtr & getSkeleton() const { return skeleton; }
...
//		void createQuaternionRepresentation(kinematic::SkeletonConstPtr skeletalModel, const kinematic::SkeletonStates& skeletalData);
	...
	typedef utils::shared_ptr<JointAnglesCollection> JointAnglesCollectionPtr;
	typedef utils::shared_ptr<const kinematic::JointAnglesCollection> JointAnglesCollectionConstPtr;
}
