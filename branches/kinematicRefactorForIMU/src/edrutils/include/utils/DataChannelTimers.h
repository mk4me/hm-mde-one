...
namespace utils {
	...
	public:
		...
		typedef utils::shared_ptr<TimerReaderType> TimerReaderPtr;
		typedef utils::shared_ptr<const TimerReaderType> TimerReaderConstPtr;
	...
	public:
		...
		typedef utils::shared_ptr<TimerType> TimerPtr;
		typedef utils::shared_ptr<const TimerType> TimerConstPtr;
