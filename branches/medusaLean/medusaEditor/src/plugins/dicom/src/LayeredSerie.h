...
namespace dicom {
    ...
    public:
		...
		medusaDatabase::IHMDBShallowCopyContext * sourceContext() const;

		static medusaDatabase::IHMDBShallowCopyContext * sourceContextForData(const core::VariantConstPtr data);
    ...
    private:
		...
		medusaDatabase::IHMDBShallowCopyContext * shallowContext_;
        bool initialized;
