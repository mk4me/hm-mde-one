...
AnnotationStatusFilter * AnnotationStatusFilter::create(medusaDatabase::IHMDBSession * session) const
{
...
void AnnotationStatusFilter::groupAnnotations(medusaDatabase::IHMDBSession * session,
