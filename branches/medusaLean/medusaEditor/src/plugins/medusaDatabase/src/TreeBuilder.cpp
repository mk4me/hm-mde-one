...
#include <plugins/medusaDatabase/TreeItemHelper.h>
...
//    }
//    
//	if (session->hasObject(typeid(medusaDatabase::IPatient), false)) {
//		core::ConstVariantsList patients;
//		session->getObjects(patients, typeid(medusaDatabase::IPatient), false);
//        medusaDatabase::PatientConstPtr patient = patients.front()->get();
//        text += QObject::tr("Patient: ") + QString::fromStdString(patient->getName()) + " " + QString::fromStdString(patient->getSurname()) + "\n";
//    }
//
//	if (session->hasObject(typeid(medusaDatabase::AntropometricData), false)) {
//		core::ConstVariantsList antropo;
//		session->getObjects(antropo, typeid(medusaDatabase::AntropometricData), false);
//        utils::shared_ptr<const medusaDatabase::AntropometricData> antro = antropo.front()->get();
//        text += " ";
