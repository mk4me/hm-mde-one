...
DataSourcePerspective::DataSourcePerspective(const medusaDatabase::IDataSourcePerspectivePtr & perspective)
...
const medusaDatabase::IDataSourcePerspectivePtr & DataSourcePerspective::perspective() const
{
	return perspective_;
}
...
void DataSourcePerspective::rebuildPerspective(const medusaDatabase::ShallowCopy & shallowCopy)
{
...
void DataSourceDisorderPerspective::rebuildPerspective(QTreeWidgetItem * treeWidgetItem, const medusaDatabase::ShallowCopy & shallowCopy)
{
...
void DataSourceGenderPerspective::rebuildPerspective(QTreeWidgetItem * treeWidgetItem, const medusaDatabase::ShallowCopy & shallowCopy)
{
...
const bool DataSourceGenderPerspective::fillContent(QTreeWidgetItem * item, const medusaDatabase::ShallowCopy & shallowCopy) const
{
