/********************************************************************
    ...
    purpose:  
*********************************************************************/
#ifndef HEADER_GUARD_medusaDatabase__PATIENTCARDMANAGER_H__
#define HEADER_GUARD_medusaDatabase__PATIENTCARDMANAGER_H__

#include <plugins/medusaDatabase/IPatientCardManager.h>
#include <utils/SmartPtr.h>
#include <vector>

class PatientCardManager : public medusaDatabase::IPatientCardManager
{
private:

	typedef utils::shared_ptr<medusaDatabase::IPatientCard> PatientCardPtr;
...
public:
	...
	virtual int registerPatientCard(medusaDatabase::IPatientCard * patientCard);
	//! \return Aktualna karty pacjenta
	virtual medusaDatabase::IPatientCard * currentPatientCard() const;
...
#endif	//	HEADER_GUARD_medusaDatabase__PATIENTCARDMANAGER_H__
