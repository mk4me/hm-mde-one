/********************************************************************
	...
	purpose:
*********************************************************************/
#ifndef __HEADER_GUARD_medusaDatabase__SOURCEOPTIONSWIDGET_H__
#define __HEADER_GUARD_medusaDatabase__SOURCEOPTIONSWIDGET_H__
...
class medusaDatabase_EXPORT SourceOptionsWidget : public QWidget
{
	Q_OBJECT
...
public:
	...
	void setConnectionProfile(const medusaDatabase::IHMDBSourceViewManager::ContextConfiguration & connectionProfile);
	const medusaDatabase::IHMDBSourceViewManager::ContextConfiguration& getConnectionProfile() const;
...
private:
	...
	static void verify(medusaDatabase::IHMDBSession * session, QStringList & errors);
...
private:
	...
	medusaDatabase::IHMDBSourceViewManager::ContextConfiguration currentConnectionProfile;
};




#endif	// __HEADER_GUARD_medusaDatabase__SOURCEOPTIONSWIDGET_H__
