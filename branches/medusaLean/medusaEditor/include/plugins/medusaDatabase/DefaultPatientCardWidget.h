/********************************************************************
	...
	purpose:
	*********************************************************************/
#ifndef HEADER_GUARD_medusaDatabase__DEFAULTPATIENTCARDWIDGET_H__
#define HEADER_GUARD_medusaDatabase__DEFAULTPATIENTCARDWIDGET_H__

#include <plugins/medusaDatabase/Export.h>
#include <plugins/medusaDatabase/IPatientCard.h>
...
class medusaDatabase_EXPORT DefaultPatientCardWidget : public QFrame
{
	Q_OBJECT
...
class medusaDatabase_EXPORT DefaultPatientCard : public medusaDatabase::IPatientCard
{
public:
...
#endif	//	HEADER_GUARD_medusaDatabase__DEFAULTPATIENTCARDWIDGET_H__
