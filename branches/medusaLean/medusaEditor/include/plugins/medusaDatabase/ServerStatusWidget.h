...
public:
	...
	ServerStatusWidget(const QPixmap & online = QPixmap(QString(":/medusaDatabase/icons/dostepny.png")),
		const QPixmap & offline = QPixmap(QString(":/medusaDatabase/icons/niedostepny.png")),
		const QPixmap & unknown = QPixmap(QString(":/medusaDatabase/icons/nieznanydostepny.png")),
		const QPixmap & partialyOnline = QPixmap(QString(":/medusaDatabase/icons/czesciowodostepny.png")),
