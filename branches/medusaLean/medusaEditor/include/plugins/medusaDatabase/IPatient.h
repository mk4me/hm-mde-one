/********************************************************************
    ...
    purpose:
*********************************************************************/
#ifndef HEADER_GUARD_medusaDatabase__IPATIENT_H__
#define HEADER_GUARD_medusaDatabase__IPATIENT_H__
...
DEFINE_WRAPPER(medusaDatabase::IPatient, utils::PtrPolicyStd, utils::ClonePolicyNotImplemented);
DEFINE_WRAPPER(medusaDatabase::AntropometricData, utils::PtrPolicyStd, utils::ClonePolicyCopyConstructor);

#endif //HEADER_GUARD_medusaDatabase__IPATIENT_H__
