...
namespace hmdbServices
{
	...
	public:
		...
		*/
		GeneralBasicQueriesWS(networkUtils::IWSDLServicePtr wsdlService);
		/**
		...
		*/
		...
		virtual DateTime dataModificationTime() const;
		//! \return Data ostatniej modyfikacji metadanych
		virtual DateTime metadataModificationTime() const;
	...
	public:
		...
		*/
		MotionBasicQueriesWS(networkUtils::IWSDLServicePtr wsdlService);
		/**
	...
	public:
		...
		Konstruktor klasy MotionBasicQueriesService.
		*/
		MedicalBasicQueriesWS(networkUtils::IWSDLServicePtr wsdlService);
		/**
		Wirtualny destruktor klasy MotionBasicQueriesService.
		*/
