...
namespace communication
{
    ...
    protected:
        ...
        public:
            ...
            {
                //hack na potrzeby zwalniania zasobów bazy medycznej - aktualnie nie wspierane przez bazę
                try{
    ...
    protected:
        ...
        /**
		Szyfrowane połączenie FTP.
		*/
        core::shared_ptr<FtpsConnection> ftp;

        /**
		Funkcjonalność web serwisu MotionFileStoremanService.
		*/
    ...
    public:
		...
		*/
		...
		@return ścieżka do pliku xml z kopią db ruchu.
		*/
		...
		@return ścieżka do pliku xml z metadanymi ruchu.
		*/
