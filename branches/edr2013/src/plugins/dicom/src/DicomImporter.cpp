...
//}
//
//dicom::DicomInternalStructPtr DicomImporter::import( const core::Filesystem::Path& from )
//{
...
//}
//
//void dicom::DicomImporter::convertImages( DicomInternalStructPtr inter, const core::Filesystem::Path& from, const core::Filesystem::Path& to )
//{
...
//}
//
//void dicom::DicomImporter::convertImage( internalData::ImagePtr inter, const core::Filesystem::Path& from, const core::Filesystem::Path& to, const std::string& filenameBase )
//{
...
//
//
//std::vector<DicomInternalStructPtr> dicom::DicomImporter::split( DicomInternalStructPtr root )
//{
...
//
//dicom::DicomImporter::DicomImporter( int studyFristId /*= 1*/ ) : 
//    studyCurrentIndex(studyFristId)
//{
//    refresh = dummy;
//}
//
//void dicom::DicomImporter::setCallBack( refresher r )
//{
//    refresh = r;
//}
//
...
//}
//
//dicom::DicomInternalStructPtr dicom::DicomLoader::load( const core::Filesystem::Path& from )
//{
//    DicomInternalStructPtr inter = utils::make_shared<DicomInternalStruct>();
