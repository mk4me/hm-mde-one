/********************************************************************
	...
	purpose:
	*********************************************************************/
#ifndef __HEADER_GUARD_HMDBCOMMUNICATION__BASICUPDATESWS_H__
#define __HEADER_GUARD_HMDBCOMMUNICATION__BASICUPDATESWS_H__
...
{
	class MotionBasicUpdatesWS : public hmdbServices::IMotionBasicUpdatesWS
	{
	public:
		/**
		Konstruktor klasy MotionBasicUpdatesService.
		*/
		MotionBasicUpdatesWS(const WSDLServiceCreator creator);
		/**
	...
	class MedicalBasicUpdatesWS : public hmdbServices::IMedicalBasicUpdatesWS
	{
	public:
		MedicalBasicUpdatesWS(const WSDLServiceCreator creator);
...
#endif	// __HEADER_GUARD_HMDBCOMMUNICATION__BASICUPDATESWS_H__
