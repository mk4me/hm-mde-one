...
*********************************************************************/
#ifndef HEADER_GUARD_UTILS__JOBMANAGER_H__
#define HEADER_GUARD_UTILS__JOBMANAGER_H__
...
private:
	//! Implementacja
	shared_ptr<JobManagerImpl> impl_;
...
#endif  //  HEADER_GUARD_UTILS__JOBMANAGER_H__
