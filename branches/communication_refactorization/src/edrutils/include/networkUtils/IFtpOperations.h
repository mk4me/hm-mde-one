...
purpose:
*********************************************************************/
#ifndef HEADER_GUARD___IFTPOPERATIONS_H__
#define HEADER_GUARD___IFTPOPERATIONS_H__
...
namespace networkUtils
{
	...
	public:
		...
		public:
			...
			virtual ~IProgress() {}
			//! \param progress Postêp w zakresie od 0.0 do 1.0
			virtual const double progress() const = 0;
			//! \return Aktualna prêdkoœc pobierania [bytes/second]
			virtual double speed() const = 0;
			//! \return Iloœæ danych ju¿ przetworzona [bytes]
			virtual const unsigned long long size() const = 0;
			//! \return Iloœæ czasu jaki up³yn¹³ od rozpoczêcia zadania [seconds]
			virtual const double elapsed() const = 0;
			//! Anuluje operacjê
	...
	public:
		...
		*/
		virtual const IProgress * putFile(const std::istream * localSource,
		...
		@return Obiekt obs³uguj¹cy postêp operacji i steruj¹cy jej wykonaniem
		*/
		virtual const IProgress * getFile(const std::string& remoteSource,
...
#endif	//	HEADER_GUARD___IFTPOPERATIONS_H__
