...
void DataSourceStatusManager::refreshDataStatus(const std::set<int> & modifiedFilesStatus)
{
	...
	std::map<int, const hmdbServices::MedicalShallowCopy::Disorder*> disordersToUpdate;
	std::map<int, const hmdbServices::MedicalShallowCopy::Patient*> patientsToUpdate;
	std::map<int, const hmdbServices::MotionShallowCopy::Performer*> subjectsToUpdate;
	std::map<int, const hmdbServices::MotionShallowCopy::Session*> sesionsToUpdate;
	std::map<int, const hmdbServices::MotionShallowCopy::Trial*> motionsToUpdate;
