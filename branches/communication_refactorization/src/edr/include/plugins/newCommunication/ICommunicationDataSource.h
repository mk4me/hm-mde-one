...
namespace communication
{
	...
	public:
		...
		virtual const hmdbServices::xmlWsdl::AnnotationsList getAllAnnotationStatus() const = 0;
		...
		virtual const hmdbServices::DateTime lastUpdateTime() const = 0;
		//! \return Czy użytkownik to recenzent dla medusy
		virtual const bool userIsReviewer() const = 0;
		//! \return Użytkownicy bazy
		virtual const hmdbServices::xmlWsdl::UsersList listUsers() const = 0;
