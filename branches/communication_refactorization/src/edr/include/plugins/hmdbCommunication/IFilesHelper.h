/********************************************************************
    ...
    purpose:  
*********************************************************************/
#ifndef HEADER_GUARD_HMDBCOMMUNICATION__IFILESHELPER_H__
#define HEADER_GUARD_HMDBCOMMUNICATION__IFILESHELPER_H__
...
public:
    ...
    //! \param dest [out] Zbiór przefiltrowanych plików załadowanych do DataManagera
    virtual void filterLoadedFiles(const std::set<int> & src, std::set<int> & dest) const = 0;
    //! \param src Zbiór plików wejsciowych do przefiltrowania
    //! \param dest [out] Zbiór przefiltrowanych plików niezaładowanych do DataManagera
...
#endif	//	HEADER_GUARD_HMDBCOMMUNICATION__IFILESHELPER_H__
