...
namespace COLLADASaxFWL
{
	...
	public:
		...
		virtual bool loadDocument(const String& fileName, COLLADAFW::IWriter* writer, bool parseDocument);
		...
		/** Starts loading the model and feeds the writer with data.
         ...
         @param writer The writer that should be fed with data.
         @return True, if loading succeeded, false otherwise.*/
		virtual bool loadDocument( const String& uri, const char* buffer, int length, COLLADAFW::IWriter* writer, bool parseDocument);
