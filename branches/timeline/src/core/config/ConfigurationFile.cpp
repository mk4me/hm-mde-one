...
//------------------------------------------------------------------------------------------------
bool ConfigurationFile::LoadConfig(std::string fileName)
{
...
//------------------------------------------------------------------------------------------------
int ConfigurationFile::GetIntParameter(std::string pName)
{
...
//------------------------------------------------------------------------------------------------
float ConfigurationFile::GetFloatParameter(std::string pName)
{
    std::list<ConfigurationGroup*> cGroup = m_buffer->GetConfigurationGroupList();
    std::string pValue = "";
    for(std::list<ConfigurationGroup*>::iterator it = cGroup.begin(); it != cGroup.end(); it++)
...
//------------------------------------------------------------------------------------------------
void ConfigurationFile::SetParameter(std::string cGroupName, std::string pName, std::string pValue)
{
    std::list<ConfigurationGroup*> cGroup = m_buffer->GetConfigurationGroupList();
    for(std::list<ConfigurationGroup*>::iterator it = cGroup.begin(); it != cGroup.end(); it++)
    {
...
//------------------------------------------------------------------------------------------------
void ConfigurationFile::SetParameter( std::string pName, std::string pValue )
{
    std::list<ConfigurationGroup*> cGroup = m_buffer->GetConfigurationGroupList();
    for(std::list<ConfigurationGroup*>::iterator it = cGroup.begin(); it != cGroup.end(); it++)
    {
...
//------------------------------------------------------------------------------------------------
ConfigurationGroup* ConfigurationFile::GetConfigurationGroup( std::string groupName )
{
    std::list<ConfigurationGroup*> cGroup = m_buffer->GetConfigurationGroupList();
    for(std::list<ConfigurationGroup*>::iterator it = cGroup.begin(); it != cGroup.end(); it++)
    {
...
//------------------------------------------------------------------------------------------------
void ConfigurationFile::CheckLine(std::string line)
{
 //   isConfigurationGroup = false;
	static std::string configurationGroupName;
...
//------------------------------------------------------------------------------------------------
std::list<ConfigurationGroup*>& ConfigurationFile::GetConfigurationGroupList()
{
    return m_buffer->GetConfigurationGroupList();
}

//------------------------------------------------------------------------------------------------
bool ConfigurationFile::IsTrue( const std::string& strName, bool defaultValue /*= false*/ ) const
{
    return true;
}

//------------------------------------------------------------------------------------------------
bool ConfigurationFile::IsFalse( const std::string& strName, bool defaultValue /*= true*/ ) const
{
    return true;
}

//------------------------------------------------------------------------------------------------
void ConfigurationFile::AddNewConfigurationGroup(std::string name)
{
...
//------------------------------------------------------------------------------------------------
void ConfigurationFile::AddNewConfigurationGroup(ConfigurationGroup& cGroup)
{
	m_buffer->AddNewConfigurationGroup(cGroup);
}
...
//------------------------------------------------------------------------------------------------
void ConfigurationFile::ClearBuffer()
{
    m_buffer->Clear();
}
