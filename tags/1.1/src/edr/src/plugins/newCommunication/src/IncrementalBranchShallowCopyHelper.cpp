...
webservices::IncrementalBranchShallowCopy communication::IncrementalBranchShallowCopyHelper::getIncrementalShallowCopy(CommunicationManager* cm, const std::string& savePath, const webservices::DateTime& dt )
{
    ...
    if (s == Success) {
        webservices::IncrementalBranchShallowCopy shallow;
        webservices::IncrementalBranchShallowCopyParser::parseFile(savePath, shallow);
        return shallow;
    } else {
