...
#define LEFT_SIDE_COLOR   new osg::Vec4(0.0, 0.0, 1.0, 0.0)
#define RIGHT_SIDE_COLOR  new osg::Vec4(1.0, 0.0, 0.0, 0.0)
#define CENTER_COLOR      new osg::Vec4(0.5, 0.0, 0.5, 0.0)
