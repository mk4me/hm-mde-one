...
template <> const __EnumInitializer<TYPE> Enum<TYPE>::initializer = __EnumInitializer<TYPE>();
...
public:
    //! Jedyna klasa która mo¿e dobraæ siê do prywatnych danych.
    //! Domyœlna instancja typu.
    static const EnumInitializer initializer;
...
public:
    ...
    {
        return initializer.data.getName(value);
    }
    //! \param Wartoœæ dla której zwróciæ nazwê.
    //! \return Nazwa.
    //! \throws std::invalid_argument
    ...
    {
        return initializer.data.parse(name);
    }
    //! \return Liczba enumów.
    static size_type size()
    {
        return initializer.data.size();
    }

    //! \return Iterator.
    const_iterator begin()
    {
        return initializer.data.byValues.begin();
    }
    //! \return Iterator.
    const_iterator end()
    {
        return initializer.data.byValues.end();
    }
    //! \return Iterator.
