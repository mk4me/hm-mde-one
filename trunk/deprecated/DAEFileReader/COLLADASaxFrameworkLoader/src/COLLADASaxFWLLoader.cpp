...
namespace COLLADASaxFWL
{
	...
	//---------------------------------
	bool Loader::loadDocument( const String& fileName, COLLADAFW::IWriter* writer, bool parseDocument)
	{
		if ( !writer )
			return false;
		mWriter = writer;
	...
	//---------------------------------
	bool Loader::loadDocument( const String& uri, const char* buffer, int length, COLLADAFW::IWriter* writer, bool parseDocument)
	{
		if ( !writer )
			return false;
		mWriter = writer;
