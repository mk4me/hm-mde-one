...
macro(ON_PROJECT_ADDED name)
	...
	# message(".........")
	# message("${${name}_INCLUDE_DIR}")
	# message("${DEFAULT_PROJECT_INCLUDES}")
	# message(${PROJECT_BINARY_DIR}/${name})
		# message(${PROJECT_BUILD_ROOT})
		# message(${PROJECT_INCLUDE_ROOT})
	...
	if (ADD_PROJECT_FAILED)
		...
		foreach (value ${dependencies})
			...
			if ( ${value}_INCLUDE_CONFIG_DIR )
				...
				#message(${${value}_INCLUDE_CONFIG_DIR})
			endif()
		endforeach()

		add_subdirectory(${name})
		#message(${DEFAULT_PROJECT_INCLUDES})
		#message("INCLUDE DIRECTORIES after ADD PROJECT ${DEFAULT_PROJECT_INCLUDES}")
	endif()
