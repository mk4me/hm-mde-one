...
# OSG
set(OSG_VERSIONS "74,73,72,71,70,69,68,67,66,65,64,63,62")
...
FIND_SHARED(OSG_LIBQT osgQt "osg<${OSG_VERSIONS}>-osgQt")

# OpenThreads
set(OPENTHREADS_VERSIONS "14,13,12,11")
FIND_SHARED(OSG_LIBOPENTHREADS OpenThreads "ot<${OPENTHREADS_VERSIONS}>-OpenThreads")

set(OSGPLUGINS_VERSIONS "2.9.15;2.9.14;2.9.13;2.9.12;2.9.11;2.9.10;2.9.9;2.9.8;2.9.7;2.9.6")
