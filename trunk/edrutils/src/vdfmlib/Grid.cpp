...
void Grid::adjustDimensions( osgWidget::point_type width, osgWidget::point_type height, const std::vector<osgWidget::point_type>& aspectRatios )
{
    ...
    BOOST_ASSERT(aspectRatios.size() == getNumObjects());
    ...
    // mo�na tak zrobi�, gdy� nowy rozmiar >= bie��cy
    // TODO: czy to poprawne? mo�e powodowa� rozrost do niesko�czono�ci
...
//         }
// 
//         // czy zaj�to ��cznie wi�cej miejsca ni� poprzednio?
...
{
    using namespace osgWidget;
    // kod wzi�ty z osgWidget::Table, nieznacznie zmodyfikowany
...
{
    BOOST_ASSERT(column < getNumColumns());
