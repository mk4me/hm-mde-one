...
template <class PtrPolicy, class Base>
class VideoInput;
...
public:
  ...
  virtual double getFrameEndTimestamp() const = 0;
  ...
  inline void setNormalizedTime(double normalizedTime)
  {
