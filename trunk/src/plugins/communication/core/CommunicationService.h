...
@brief Klasa CommunicationService wykorzystujaca wzorce projektowe fasada oraz singleton do zarzadzania polaczeniem
...
namespace EDRCM {
	...
	private:
		/**
		Wskaznik na jedyna instancje klasy CommunicationService.
		*/
		static CommunicationService* pInstance;
		/**
	...
	public:
		/**
		Pusty konstruktor klasy CommunicationService.
		*/
		CommunicationService() {}
		/**
		Pusty wirtualny destruktor klasy CommunicationService.
		*/
		virtual ~CommunicationService() {}
		/**
		Metoda statyczna zwracajaca instancje klasy CommunicationService. Ta metoda pozwala nam na 
		...
		@return statyczny wskaznik na obiekt typu CommunicationService
		*/
		static CommunicationService* getInstance();
		/**
		Metoda statyczna zwracajaca instancje klasy CommunicationService pierwszy raz.
		@return statyczny wskaznik na obiekt typu CommunicationService
		*/
		static CommunicationService* createInstanceFirstTime();
		/**
		Metoda zwalniajaca pamiec po klasie CommunicationService. Nalezy wywolac za kazdym razem gdy
		konczymy prace z instancja klasy. Jest to jedyny sposob na zwolnienie zasobow z powodu wykorzystania
		singletona.
		*/
		void destoryInstance();
		/**
		Metoda inicjalizujaca wszystkie obiekty powiazane z CommunicationService.
