...
bool inline InBox( CVec3 Hit, CVec3 B1, CVec3 B2, const int Axis ) {
    if ( Axis == 1 && Hit._v[2] > B1._v[2] && Hit._v[2] < B2._v[2] && Hit._v[1] > B1._v[1] && Hit._v[1] < B2._v[1]) return true;
    if ( Axis == 2 && Hit._v[2] > B1._v[2] && Hit._v[2] < B2._v[2] && Hit._v[0] > B1._v[0] && Hit._v[0] < B2._v[0]) return true;
    if ( Axis == 3 && Hit._v[0] > B1._v[0] && Hit._v[0] < B2._v[0] && Hit._v[1] > B1._v[1] && Hit._v[1] < B2._v[1]) return true;
    return false;
}
...
bool CheckLineBox( CVec3 L1, CVec3 L2, CVec3 B1, CVec3 B2, CVec3 &HitP )
{
    ...
    if (L2._v[0] < B1._v[0] && L1._v[0] < B1._v[0]) return false;
    if (L2._v[0] > B2._v[0] && L1._v[0] > B2._v[0]) return false;
    if (L2._v[1] < B1._v[1] && L1._v[1] < B1._v[1]) return false;
    if (L2._v[1] > B2._v[1] && L1._v[1] > B2._v[1]) return false;
    if (L2._v[2] < B1._v[2] && L1._v[2] < B1._v[2]) return false;
    if (L2._v[2] > B2._v[2] && L1._v[2] > B2._v[2]) return false;

    // Check if the line originates in the box
    if (L1._v[0] > B1._v[0] && L1._v[0] < B2._v[0] && L1._v[1] > B1._v[1] && L1._v[1] < B2._v[1] && L1._v[2] > B1._v[2] && L1._v[2] < B2._v[2] ) {
        HitP = L1; 
        return true;
    }

    // Check for a line intersection with each side of the box
    if ( GetIntersection( L1._v[0]-B1._v[0], L2._v[0]-B1._v[0], L1, L2, HitP) && InBox( HitP, B1, B2, 1 ) ) return true;
    if ( GetIntersection( L1._v[1]-B1._v[1], L2._v[1]-B1._v[1], L1, L2, HitP) && InBox( HitP, B1, B2, 2 ) ) return true;
    if ( GetIntersection( L1._v[2]-B1._v[2], L2._v[2]-B1._v[2], L1, L2, HitP) && InBox( HitP, B1, B2, 3 ) ) return true;
    if ( GetIntersection( L1._v[0]-B2._v[0], L2._v[0]-B2._v[0], L1, L2, HitP) && InBox( HitP, B1, B2, 1 ) ) return true;
    if ( GetIntersection( L1._v[1]-B2._v[1], L2._v[1]-B2._v[1], L1, L2, HitP) && InBox( HitP, B1, B2, 2 ) ) return true;
    if ( GetIntersection( L1._v[2]-B2._v[2], L2._v[2]-B2._v[2], L1, L2, HitP) && InBox( HitP, B1, B2, 3 ) ) return true;
