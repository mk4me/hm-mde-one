...
void DataSourceStatusManager::refreshDataStatus(const std::set<int> & modifiedFilesStatus)
{
    ...
    //znajdŸ wspólne motiony do odœwie¿enia
    //znajdŸ wspólne sesje do odœwie¿enia
    //znajdŸ wsólnych subjectów do odœwie¿enia
    //znajdŸ wspólnych pacjentów do odœwie¿enia
    //znajdŸ wspólne schorzenia do odœwie¿enia
