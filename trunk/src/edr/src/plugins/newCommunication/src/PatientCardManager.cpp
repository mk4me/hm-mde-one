...
int PatientCardManager::registerPatientCard(communication::IPatientCard * patientCard)
{
...
communication::IPatientCard * PatientCardManager::currentPatientCard() const
{
