...
namespace communication {
    ...
    {
    public:
        static webservices::IncrementalBranchShallowCopy getIncrementalShallowCopy(CommunicationManager* cm, const std::string& savePath, const webservices::DateTime& dt);
