...
{
    UTILS_ASSERT((source != nullptr), "Błędne źródło danych dla DataExplorer");
    ...
    //dodanie źródła do widgeta

    addSourceToWidget(source);

    //ostateczna rejestracja źródła
...
void DataExplorerService::addSourceToWidget(IDataExplorerSource * source)
{
    ...
    //dzielimy widok na pół w poziomie
