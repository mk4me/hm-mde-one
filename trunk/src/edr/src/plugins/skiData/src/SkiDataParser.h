/********************************************************************
	created:  2016/07/18
	filename: SkiDataParser.h
	author:	  Mateusz Janiak
	
	purpose:  
*********************************************************************/
#ifndef __HEADER_GUARD_SKIDATA__SKIDATAPARSER_H__
#define __HEADER_GUARD_SKIDATA__SKIDATAPARSER_H__

#include <corelib/IParser.h>

namespace skidata
{
	class SkiDataParser : public plugin::ISourceParser
	{
		UNIQUE_ID("33178925-FC36-BACA-B0EC-25F5268BE1F2")
		CLASS_DESCRIPTION("Ski data parser", "Ski data parser")
	public:
		//! Konstruktor domyœlny
		SkiDataParser();
		//! Destruktor wirtualny
		virtual ~SkiDataParser();
...
#endif  // __HEADER_GUARD_SKIDATA__SKIDATAPARSER_H__