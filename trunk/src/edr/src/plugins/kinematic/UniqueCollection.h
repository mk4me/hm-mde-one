...
//! Prosta metoda, rzucajaca ostr¹ asercjê, gdy próbujemy dodaæ obiekt, który ju¿ istnieje w kolecji
...
//! Prosta metoda, rzucajaca ostr¹ asercjê, gdy próbujemy usun¹æ obiekt, którego nie ma w kolecji
