...
QTreeWidgetItem* SimpleFilterCommand::createEMGBranch( MotionPtr motion, const QString& rootName, const QIcon& itemIcon )
{
...
QTreeWidgetItem*  SimpleFilterCommand::createGRFBranch( MotionPtr motion, const QString& rootName, const QIcon& itemIcon )
{
...
QTreeWidgetItem* SimpleFilterCommand::createVideoBranch( MotionPtr motion, const QString& rootName, const QIcon& itemIcon )
{
...
QTreeWidgetItem* SimpleFilterCommand::createJointsBranch( MotionPtr motion, const QString& rootName, const QIcon& itemIcon )
{
...
QTreeWidgetItem* SimpleFilterCommand::createMarkersBranch( MotionPtr motion, const QString& rootName, const QIcon& itemIcon )
{
