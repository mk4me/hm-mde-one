...
namespace core
{
    ...
    //! Interfejs ürÛd≥a danych. Powinien to byÊ jedeny obiekt inicjowany i majπcy dostÍp do MemoryDM i FIleDM
    ...
    public:
        ...
        //! Generalnie to taki bezpieczny destruktor uniezaleøniajπcy dana us≥ugÍ od pozosta≥ych us≥ug i przygotowujπcy ja na usuniecie
