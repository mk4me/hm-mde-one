...
/**
 *	Przykładowa, najprotsza implementacja adaptera. Bazuje na obiektach boost::function.
 *  Używany jest przy definicji domyślnych styli, ale można go wykorzystać również w kodzie
 *  klienckim.
 */
