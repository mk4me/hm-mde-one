/********************************************************************
    created:  2013/06/18
    created:  18:6:2013   11:56
    filename: RerunnableThread.h
    author:   Mateusz Janiak
    
    purpose:  Wątek "niekończący się róg obfitości" - można go anulowac
				i wzbudzać dowolną ilość razy, tworzy nowe tylko kiedy
				nastapiło anulowanie
*********************************************************************/
#ifndef HEADER_GUARD___RERUNNABLETHREAD_H__
...
namespace utils {
	...
	class RerunnableThread : public IThread
	{
	private:
		//! Implementacja klasy RerunableThread
		class RerunnableThreadImpl;

	private:
		//! Implementacja
		shared_ptr<RerunnableThreadImpl> impl_;

	public:
		//! Konstruktor
		//! \param Fabryka wątków
		RerunnableThread(IThreadFactoryPtr threadFactory);
		//! Wirtualny destruktor
		virtual ~RerunnableThread();
...
#endif	//	HEADER_GUARD___RERUNNABLETHREAD_H__
