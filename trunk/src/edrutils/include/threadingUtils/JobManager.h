...
namespace threadingUtils
{
	...
	public:
		...
		private:
			...
			Job(WorkManager * workManager, F&& f, Args&& arguments...) : workManager(workManager),
		...
		public:
			...
			Job() : workManager(nullptr), detached_(false) {}

			//! Konstruktor przenosz¹cy w³asnoœæ
			Job(Job && Other) : workManager(std::move(Other.workManager)),
