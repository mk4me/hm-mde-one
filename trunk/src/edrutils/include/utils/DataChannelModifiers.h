...
namespace utils {
	...
	//! Interfejs obiektu obserwującego kanał, udającego kanał, wykonującego zadane operacje na kanale
	...
	private:
		...
		//! Prywatna klasa realizująca obserwację zadanej klasy. Na jej zmianę wyzwala modyfikacje
	...
	private:
		...
		utils::shared_ptr<UpdateNotifier> notifier;
		bool changed;
