    ...
    file->BeginChunk(FMODEL_PLUGIN);
    {
        ...
        file->BeginChunk(FMODEL_BONES);
        {
            ...
            for(size_t i=0; i<boneCount; ++i)
            {
                ...
                FMVector3 translation = localTransform.GetTranslation()*Parameters::GetScale();  
                ...
                translation = boneSpace.GetTranslation()*Parameters::GetScale(); 
        ...
        file->BeginChunk(FMODEL_SKELETON_ANIMATION); 
        {
            ...
            for(size_t i=0; i<boneCount; ++i)
            {
                ...
                for(size_t j=0; j<keyCount; ++j)
                {
                    ...
                    FMVector3 translation = transformation.GetTranslation()*Parameters::GetScale(); 
