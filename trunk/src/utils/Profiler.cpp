...
inline int getListIndex( int id, const Profiler::ThreadEntry ((&list)[1] ) )
{
    return (list[0].first != id) ? -1 : 0;
}

inline int getListIndex( int id, const Profiler::ThreadEntry ((&list)[2] ) )
{
    int mod0 = (list[0].first != id) ? 0 : 1;
    int mod1 = (list[1].first != id) ? 0 : 2;
    return mod0 + mod1 - 1;
}

inline int getListIndex( int id, const Profiler::ThreadEntry ((&list)[3] ) )
{
    int mod0 = (list[0].first != id) ? 0 : 1;
    int mod1 = (list[1].first != id) ? 0 : 2;
    int mod2 = (list[2].first != id) ? 0 : 3;
    return mod0 + mod1 + mod2 - 1;
}

inline int getListIndex( int id, const Profiler::ThreadEntry ((&list)[4] ) )
{
    int mod0 = (list[0].first != id) ? 0 : 1;
    int mod1 = (list[1].first != id) ? 0 : 2;
    int mod2 = (list[2].first != id) ? 0 : 3;
    int mod3 = (list[3].first != id) ? 0 : 4;
    return mod0 + mod1 + mod2 + mod3 - 1;
}

inline int getListIndex( int id, const Profiler::ThreadEntry ((&list)[5] ) )
{
    int mod0 = (list[0].first != id) ? 0 : 1;
    int mod1 = (list[1].first != id) ? 0 : 2;
    int mod2 = (list[2].first != id) ? 0 : 3;
    int mod3 = (list[3].first != id) ? 0 : 4;
    int mod4 = (list[4].first != id) ? 0 : 5;
