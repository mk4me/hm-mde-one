...
*********************************************************************/
#ifndef HEADER_GUARD_medusaDatabase__DATASTATUS_H__
#define HEADER_GUARD_medusaDatabase__DATASTATUS_H__
...
public:
	...
	*/
	...
	bool operator<(const medusaDatabase::DataStatus & b) const;
...
bool operator==(const medusaDatabase::DataStatus & a, const medusaDatabase::DataStatus & b);
//! Operator różności statusów
bool operator!=(const medusaDatabase::DataStatus & a, const medusaDatabase::DataStatus & b);
//! Operator mniejszości
bool operator<(const medusaDatabase::DataStatus & a, const medusaDatabase::DataStatus & b);

medusaDatabase::DataStatus::DataStorage operator|(medusaDatabase::DataStatus::DataStorage l, medusaDatabase::DataStatus::DataStorage r);
medusaDatabase::DataStatus::DataStorage & operator|=(medusaDatabase::DataStatus::DataStorage & l, medusaDatabase::DataStatus::DataStorage r);
medusaDatabase::DataStatus::DataUsage operator|(medusaDatabase::DataStatus::DataUsage l, medusaDatabase::DataStatus::DataUsage r);
medusaDatabase::DataStatus::DataUsage & operator|=(medusaDatabase::DataStatus::DataUsage & l, medusaDatabase::DataStatus::DataUsage r);
medusaDatabase::DataStatus::DataValidity operator|(medusaDatabase::DataStatus::DataValidity l, medusaDatabase::DataStatus::DataValidity r);
medusaDatabase::DataStatus::DataValidity & operator|=(medusaDatabase::DataStatus::DataValidity & l, medusaDatabase::DataStatus::DataValidity r);
medusaDatabase::DataStatus operator|(const medusaDatabase::DataStatus & l, const medusaDatabase::DataStatus & r);
medusaDatabase::DataStatus & operator|=(medusaDatabase::DataStatus & l, const medusaDatabase::DataStatus & r);
medusaDatabase::DataStatus operator|(const medusaDatabase::DataStatus & l, const medusaDatabase::DataStatus::DataStorage & r);
medusaDatabase::DataStatus & operator|=(medusaDatabase::DataStatus & l, const medusaDatabase::DataStatus::DataStorage & r);
medusaDatabase::DataStatus operator|(const medusaDatabase::DataStatus & l, const medusaDatabase::DataStatus::DataUsage & r);
medusaDatabase::DataStatus & operator|=(medusaDatabase::DataStatus & l, const medusaDatabase::DataStatus::DataUsage & r);
medusaDatabase::DataStatus operator|(const medusaDatabase::DataStatus & l, const medusaDatabase::DataStatus::DataValidity & r);
medusaDatabase::DataStatus & operator|=(medusaDatabase::DataStatus & l, const medusaDatabase::DataStatus::DataValidity & r);

#endif	//	HEADER_GUARD_medusaDatabase__DATASTATUS_H__
