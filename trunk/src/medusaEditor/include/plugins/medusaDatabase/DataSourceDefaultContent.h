/********************************************************************
	...
	purpose:
*********************************************************************/
#ifndef __HEADER_GUARD_medusaDatabase__DATASOURCEDEFAULTCONTENT_H__
#define __HEADER_GUARD_medusaDatabase__DATASOURCEDEFAULTCONTENT_H__
...
{
	class medusaDatabase_EXPORT DataSourceDefaultContent : public IDataSourceContent
	{
	public:
...
#endif	// __HEADER_GUARD_medusaDatabase__DATASOURCEDEFAULTCONTENT_H__
