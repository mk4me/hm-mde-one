...
medusaDatabase::IHMDBShallowCopyContext* getShallowCopyContext()
{
...
medusaDatabase::IHMDBSession * getSession(medusaDatabase::IHMDBShallowCopyContext* srcContext)
{
	if (srcContext) {
...
Annotations getAnnotations(medusaDatabase::IHMDBSession * session)
{
	Annotations res;
