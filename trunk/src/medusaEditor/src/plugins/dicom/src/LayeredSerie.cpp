...
medusaDatabase::IHMDBShallowCopyContext * LayeredSerie::sourceContext() const
{
	return shallowContext_;
}

medusaDatabase::IHMDBShallowCopyContext * LayeredSerie::sourceContextForData(const core::VariantConstPtr data)
{
	medusaDatabase::IHMDBShallowCopyContext * ret = nullptr;
