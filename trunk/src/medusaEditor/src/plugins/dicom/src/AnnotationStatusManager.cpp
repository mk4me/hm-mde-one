...
medusaDatabase::IHMDBSession * dicom::AnnotationStatusManager::getSession(medusaDatabase::IHMDBShallowCopyContext* srcContext)
{
...
medusaDatabase::IHMDBShallowCopyContext* dicom::AnnotationStatusManager::getShallowCopyContext()
{
	auto source = core::querySource<medusaDatabase::IHMDBSource>(plugin::getSourceManager());
	if (source != nullptr) {
...
dicom::AnnotationStatusManager::Annotations dicom::AnnotationStatusManager::getAnnotations(medusaDatabase::IHMDBSession * session)
{
	Annotations res;
...
std::map<QString, int> getTrials(medusaDatabase::IHMDBShallowCopyContext* shallow)
{
...
std::map<QString, int> getUsers(medusaDatabase::IHMDBSession * session)
{
	std::map<QString, int> res;
