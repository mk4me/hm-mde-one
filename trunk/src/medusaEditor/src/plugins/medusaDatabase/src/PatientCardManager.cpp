...
int PatientCardManager::registerPatientCard(medusaDatabase::IPatientCard * patientCard)
{
...
medusaDatabase::IPatientCard * PatientCardManager::currentPatientCard() const
{
