/********************************************************************
    ...
    purpose:  
*********************************************************************/
#ifndef HEADER_GUARD_medusaDatabase__DISORDERSDATAWIDGET_H__
#define HEADER_GUARD_medusaDatabase__DISORDERSDATAWIDGET_H__
...
#endif	//	HEADER_GUARD_medusaDatabase__DISORDERSDATAWIDGET_H__
