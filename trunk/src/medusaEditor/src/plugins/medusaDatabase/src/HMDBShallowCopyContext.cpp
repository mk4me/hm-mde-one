...
#include <plugins/medusaDatabase/IHierarchyPerspective.h>
#include "Patient.h"
...
medusaDatabase::StorageFileNames filterSupportedFiles(const medusaDatabase::StorageFileNames & inFiles)
{
...
medusaDatabase::StorageFileNames filterFiles(const medusaDatabase::StorageFileNames & inFiles,
...
void HMDBShallowCopyLocalContext::addPatientObject(const hmdbServices::MedicalShallowCopy::Patient * patient, PluginSubject::SubjectID subjectID)
{
	...
	//dodaję do DM
	auto pOW = core::Variant::create<medusaDatabase::IPatient>();
	pOW->set(pPtr);
...
utils::shared_ptr<medusaDatabase::AntropometricData> createAntropometricData(const hmdbServices::MotionShallowCopy::Attrs & attrs)
{
	auto antro = utils::shared_ptr<medusaDatabase::AntropometricData>(new medusaDatabase::AntropometricData());
	antro->bodyMass = medusaDatabase::AntropometricData::value_type(getAntropometricValue("BodyMass", attrs), "kg");
	antro->height = medusaDatabase::AntropometricData::value_type(getAntropometricValue("Height", attrs), "mm");
	antro->interAsisDistance = medusaDatabase::AntropometricData::value_type(getAntropometricValue("InterAsisDistance", attrs), "mm");

	antro->leftLegLength = medusaDatabase::AntropometricData::value_type(getAntropometricValue("LeftLegLength", attrs), "mm");
	antro->rightLegLenght = medusaDatabase::AntropometricData::value_type(getAntropometricValue("RightLegLenght", attrs), "mm");

	antro->leftKneeWidth = medusaDatabase::AntropometricData::value_type(getAntropometricValue("LeftKneeWidth", attrs), "mm");
	antro->rightKneeWidth = medusaDatabase::AntropometricData::value_type(getAntropometricValue("RightKneeWidth", attrs), "mm");

	antro->leftAnkleWidth = medusaDatabase::AntropometricData::value_type(getAntropometricValue("LeftAnkleWidth", attrs), "mm");
	antro->rightAnkleWidth = medusaDatabase::AntropometricData::value_type(getAntropometricValue("RightAnkleWidth", attrs), "mm");

	antro->leftCircuitThigh = medusaDatabase::AntropometricData::value_type(getAntropometricValue("LeftCircuitThigh", attrs), "mm");
	antro->rightCircuitThight = medusaDatabase::AntropometricData::value_type(getAntropometricValue("RightCircuitThight", attrs), "mm");

	antro->leftCircuitShank = medusaDatabase::AntropometricData::value_type(getAntropometricValue("LeftCircuitShank", attrs), "mm");
	antro->rightCircuitShank = medusaDatabase::AntropometricData::value_type(getAntropometricValue("RightCircuitShank", attrs), "mm");

	antro->leftShoulderOffset = medusaDatabase::AntropometricData::value_type(getAntropometricValue("LeftShoulderOffset", attrs), "mm");
	antro->rightShoulderOffset = medusaDatabase::AntropometricData::value_type(getAntropometricValue("RightShoulderOffset", attrs), "mm");

	antro->leftElbowWidth = medusaDatabase::AntropometricData::value_type(getAntropometricValue("LeftElbowWidth", attrs), "mm");
	antro->rightElbowWidth = medusaDatabase::AntropometricData::value_type(getAntropometricValue("RightElbowWidth", attrs), "mm");

	antro->leftWristWidth = medusaDatabase::AntropometricData::value_type(getAntropometricValue("LeftWristWidth", attrs), "mm");
	antro->rightWristWidth = medusaDatabase::AntropometricData::value_type(getAntropometricValue("RightWristWidth", attrs), "mm");

	antro->leftWristThickness = medusaDatabase::AntropometricData::value_type(getAntropometricValue("LeftWristThickness", attrs), "mm");
	antro->rightWristThickness = medusaDatabase::AntropometricData::value_type(getAntropometricValue("RightWristThickness", attrs), "mm");

	antro->leftHandWidth = medusaDatabase::AntropometricData::value_type(getAntropometricValue("LeftHandWidth", attrs), "mm");
	antro->rightHandWidth = medusaDatabase::AntropometricData::value_type(getAntropometricValue("RightHandWidth", attrs), "mm");

	antro->leftHandThickness = medusaDatabase::AntropometricData::value_type(getAntropometricValue("LeftHandThickness", attrs), "mm");
	antro->rightHandThickness = medusaDatabase::AntropometricData::value_type(getAntropometricValue("RightHandThickness", attrs), "mm");
	...
	const ShallowCopyConstPtr shallowCopy)
{
	...
	if (sOW == nullptr){
		...
		auto antroOW = core::Variant::create<medusaDatabase::AntropometricData>();
		antroOW->set(antro);
...
/*		core::VariantPtr jointsWrapper = createJointsAngles(motionObjects, sPtr);
		...
		//	jointsWrapper->setMetadata("source", "medusaDatabase->motion->" + mPtr->getLocalName());
		//}
...
medusaDatabase::StorageFileNames filesToProcess(const DataType type,
	const hmdbServices::ID id, const medusaDatabase::ShallowCopy & shallowCopy )
{
	auto files = medusaDatabase::ShallowCopyUtils::files(type, id, shallowCopy);
	auto extraFiles = medusaDatabase::ShallowCopyUtils::extraFiles(type, id, shallowCopy);
...
HMDBShallowCopyRemoteContext::SynchronizeOperationPtr HMDBShallowCopyRemoteContext::prepareSynchronization(IHMDBStoragePtr storage)
{
	...
	return SynchronizeOperationPtr(new medusaDatabase::SynchronizeOperation(sDownloads, storage));
}
